...
CIRCLE_POS
        defb 24,120,  28,94,   40,68,   60,48,   96,40,  128,52, 148,68, 160,88
        defb 164,120, 160,152, 144,180, 120,196, 96,200, 65,199, 44,180, 30,150  ; x,y coords in a list

;;
;; jonathan cauldwell's sprite routines
;;
